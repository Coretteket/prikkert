...
Prikkert is een gratis dienst van Quinten Coret ([prikkert@qntn.io](mailto:prikkert@qntn.io)). De broncode is [open source](https://github.com/coretteket/prikkert), vrijgegeven voor hergebruik onder de [European Union Public License](https://github.com/Coretteket/prikkert/blob/main/LICENSE). Het steven is dat de dienst altijd kosteloos en reclamevrij blijft voor gebruikers.
