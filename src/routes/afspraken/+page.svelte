<script lang="ts">
	...
	const numberResponses = (n: number) =>
		n === 0
			? 'Geen reacties'
			: n === 1
				? /* @wc-include */ '1 reactie'
				: /* @wc-include */ `${n} reacties`
</script>
...
<div class="space-y-4">
	{#each events as event (event.id)}
		<a
			...
			class="block overflow-hidden rounded-lg border px-6 py-5 hover:bg-neutral-50 motion-safe:transition-colors dark:hover:bg-neutral-825"
		>
